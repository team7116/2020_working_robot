...
import edu.wpi.first.wpilibj.DriverStation;//navX
import edu.wpi.first.wpilibj.smartdashboard.SmartDashboard;//navX
...
public class Robot extends TimedRobot {
  ...
  public void operatorControl() {
        ...
        //Timer.delay(20);		/* wait for one motor update time period (50Hz)     */
